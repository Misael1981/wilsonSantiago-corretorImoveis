...
type GalleryImagesProps = {
  property: {
    ...
    imageUrls: string[] | null | unknown
  }
}

const GalleryImages = ({ property }: GalleryImagesProps) => {
    ...
    <div className="col-span-2 h-full">
      ...
      <div className="relative aspect-4/3 w-full overflow-hidden rounded-md">
        {mainSrc ? (
          <Image
            ...
            priority // 🔥 Como é a imagem principal que carrega no topo, dá prioridade de carregamento
          />
        ) : (
      ...
      <div className="relative mt-3">
        ...
        >
          {images.map((url, i) => (
            ...
            >
              <Image
                src={url}
                alt={`${property.title} miniatura ${i + 1}`}
                fill
                className="object-cover"
                sizes="96px"
              />
        ...
        <Button
          ...
          title="Anterior"
        >
          <span className="flex items-center justify-center text-xl text-gray-700">
