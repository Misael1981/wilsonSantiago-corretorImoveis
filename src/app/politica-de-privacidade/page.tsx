            ...
            <AnimatedContent>
              ...
              <section className="space-y-6 leading-relaxed">
                <p>
                  ...
                  privacidade e se compromete com a proteção dos dados pessoais
                  de clientes, parceiros e visitantes do nosso site. Esta
                  Política de Privacidade explica como coletamos, usamos e
                  protegemos as informações fornecidas durante a navegação em{" "}
                ...
                <ul className="mt-2 list-inside list-disc space-y-1">
                  ...
                  <li>
                    Informações de navegação (como endereço IP, tipo de
                    navegador, tempo de permanência no site), coletadas
                    automaticamente por ferramentas de análise, como Google
                    Analytics.
                  </li>
                </ul>
                <h2 className="mt-10 text-xl font-semibold text-gray-900">
                ...
                <ul className="mt-2 list-inside list-disc space-y-1">
                  ...
                  <li>
                    Melhorar a experiência de navegação e personalizar o
                    conteúdo exibido.
                  </li>
                </ul>
                <h2 className="mt-10 text-xl font-semibold text-gray-900">
                ...
                <p>
                  O corretor <strong>Wilson Santiago</strong> não vende, aluga
                  ou compartilha dados pessoais com terceiros, exceto:
                </p>
                <ul className="mt-2 list-inside list-disc space-y-1">
                  <li>
                    Quando necessário para execução de serviços (ex: hospedagem
                    de site, provedores de e-mail).
                  </li>
                  <li>Quando exigido por lei ou decisão judicial.</li>
                </ul>
                <p>
                  Em todos os casos, garantimos que os terceiros mantenham o
                  mesmo nível de proteção e confidencialidade.
                </p>
                <h2 className="mt-10 text-xl font-semibold text-gray-900">
                  4. Armazenamento e segurança dos dados
                </h2>
                <p>
                  Os dados são armazenados em ambientes seguros e acessados
                  apenas por pessoas autorizadas. Adotamos medidas técnicas e
                ...
                <ul className="mt-2 list-inside list-disc space-y-1">
                  ...
                  <li>
                    Revogar o consentimento para uso de dados pessoais a
                    qualquer momento.
                  </li>
                </ul>
                ...
                <p>
                  ...
                  periodicamente. Recomendamos revisar esta página regularmente
                  para se manter informado sobre como protegemos suas
                  informações.
                </p>
                <h2 className="mt-10 text-xl font-semibold text-gray-900">
                  8. Contato
                ...
                <p>
                  ...
                  em contato com <strong>Wilson Santiago</strong> pelo e-mail{" "}
                  <strong>santiagowilsonrodrigo@gmail.com</strong>.
                </p>
              </section>
            </AnimatedContent>
